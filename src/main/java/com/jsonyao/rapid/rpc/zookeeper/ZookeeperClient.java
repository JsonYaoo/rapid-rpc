package com.jsonyao.rapid.rpc.zookeeper;
...
public interface ZookeeperClient {
	...
	/**
	 * addEphemeralNode 临时节点API：生命周期与客户端和服务器连接期间有关
	 * @param path	/aaa
	 * @param data	123
	 * @return
	 * @throws Exception
	...
	/**
	 * getNodes 获取当前节点下的直接子节点(即下一级的子结点, 而不会获取再下一级的子结点)
	 * @param path ===>	/parent
	 * @return =>	/aaa, /bbb
	 * 
	 *  	/parent   ==> 1
	...
	/**
	 * listener4ChildrenPath 监听给定节点下的直接子节点(即下一级的子结点, 而不会获取再下一级的子结点)
	 * @param parent   		/parent
	...
	/**
	 * getClient 获取当前客户端实例对象(这里使用Curator做为客户端)
	 * @return
	 */
